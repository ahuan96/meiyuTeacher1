        ...
        <div class="main long" style="top:0">
          <div class="mid">
            <el-table stripe height="100%"
              ...
              <el-table-column label="学号" prop="student_no" min-width="80" fixed></el-table-column>

              <el-table-column label="年级" prop="grade" width="80"></el-table-column>

              <el-table-column label="班级" prop="class_name" width="120"></el-table-column>

              <el-table-column label="档案" prop="file" width="150">
              ...
              <el-table-column label="实践分" prop="point" width="150"></el-table-column>
              <el-table-column label="评语" prop="remark" width="150"></el-table-column>
            </el-table>
          </div>
...
export default {
  ...
  methods: {
     ...
     */
    askDatas (cbk) {
      let $rt = this.$get('meiyu/getActivicty/', this.params)
      $rt.then((rt) => {
        // 学生数据
